...
<header><h1 style="width:8em;" class="weblog-title"><a style="text-decoration:none; border-bottom:0px" href="{base-path}"><i class="fa-solid fa-heart"></i> {weblog-title}</a></h1><div class="nav-box" style="width:25em;"> {navigation} </div></header>
